if not Holo:ShouldModify("HUD", "Teammate") or not Holo.Options:GetValue("AltTeammate") then
	return
end
...
function HUDTeammate:GetNameWidth()
	...
	return (self._main_player and not Holo.Options:GetValue("MyName")) and 0 or w
end
...
function HUDTeammate:UpdateHolo()
	...
	local show_all = me or Holo.Options:GetValue("ShowTeammatesFullAmmo")
	...
	name:configure({
        color = Holo.Options:GetValue("NameColored") and teammate_line:color() or text_color,
